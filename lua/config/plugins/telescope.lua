return {
  ...
  config = function()
    ...
    vim.keymap.set('n', "<leader>fk", "<cmd>Telescope keymaps<cr>")         -- list available commands
    vim.keymap.set('n', "<leader>fe", "<cmd>Telescope command_history<cr>") -- list command history
    vim.keymap.set('n', "<leader>fm", "<cmd>Telescope marks<cr>")           -- list available marks
